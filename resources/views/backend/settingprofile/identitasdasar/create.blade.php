...
@section('title', 'Setting Profile Perusahaan - Tambah Identitas Dasar')
@section('page-title', 'Setting Profile Perusahaan')
@section('breadcrumb', 'Setting / Profile Perusahaan / Tambah Identitas')
...
<div class="container-fluid py-4">
  ...
  <div class="card bg-dark border-0 shadow-lg rounded-4 p-4">
    <h5 class="text-white fw-semibold mb-4">
      <i class="fas fa-plus-circle me-2"></i> Tambah Identitas Dasar
    </h5>

    {{-- Form Section --}}
    <form action="{{ route('admin.settingprofile.identitas.store') }}" method="POST" enctype="multipart/form-data">
      @csrf
      @include('backend.settingprofile.identitasdasar.form')
