...
@section('title', 'Setting Profile Perusahaan - Tambah Kontak & Lokasi')
@section('page-title', 'Setting Profile Perusahaan')
@section('breadcrumb', 'Setting / Profile Perusahaan / Tambah Kontak & Lokasi')
...
<div class="container-fluid py-4">
  ...
  <div class="card bg-dark border-0 shadow-lg rounded-4 p-4">
    <h5 class="text-white fw-semibold mb-4">
      <i class="fas fa-plus-circle me-2"></i> Tambah Kontak & Lokasi
    </h5>

    <form action="{{ route('admin.settingprofile.kontak.store') }}" method="POST">
      @csrf
      @include('backend.settingprofile.kontaklokasi.form')
