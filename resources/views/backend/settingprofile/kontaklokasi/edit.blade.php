...
@section('title', 'Setting Profile Perusahaan - Edit Kontak & Lokasi')
@section('page-title', 'Setting Profile Perusahaan')
@section('breadcrumb', 'Setting / Profile Perusahaan / Edit Kontak & Lokasi')
...
<div class="container-fluid py-4">
  ...
  <div class="card bg-dark border-0 shadow-lg rounded-4 p-4">
    <h5 class="text-white fw-semibold mb-4">
      <i class="fas fa-edit me-2"></i> Edit Kontak & Lokasi
    </h5>

    <form action="{{ route('admin.settingprofile.kontak.update', $kontak->id) }}" method="POST">
      @csrf
      @method('PUT')
      @include('backend.settingprofile.kontaklokasi.form', ['kontak' => $kontak])
      ...
      <div class="mt-4 d-flex justify-content-end gap-2">
        ...
        <a href="{{ route('admin.settingprofile.kontak.index') }}" class="btn btn-outline-light fw-semibold shadow-sm px-4">
