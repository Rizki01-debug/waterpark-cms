...
@section('title', 'Setting Profile Perusahaan - Edit Sosial Media')
@section('page-title', 'Setting Profile Perusahaan')
@section('breadcrumb', 'Setting / Profile Perusahaan / Edit Sosial Media')
...
<div class="container-fluid py-4">
  ...
  <div class="card bg-dark border-0 shadow-lg rounded-4 p-4">
    <h5 class="text-white fw-semibold mb-4">
      <i class="fas fa-edit me-2"></i> Edit Sosial Media
    </h5>

    <form action="{{ route('admin.settingprofile.sosial.update', $social->id) }}" method="POST">
      @csrf
      @method('PUT')
      @include('backend.settingprofile.sosialmedia.form', ['social' => $social])
